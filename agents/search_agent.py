...
def create_activity_search_agent() -> Agent[TripContext]:
    ...
    from .kid_friendly_agent import create_kid_friendly_agent  # Import locally to avoid potential circular dependency
    kid_friendly_agent = create_kid_friendly_agent()
